...
public class ComputerController {
    ...
    @PostMapping
    public ResponseEntity<Void> adicionarComputer(@RequestBody Computer computer) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deletarComoputador(@PathVariable Long id) {
        this.computerService.deletar(id);
        return ResponseEntity.ok().build();
    }

    @PutMapping("/{id}")
    public ResponseEntity<Void> atualizarComputador(@PathVariable Long id, @RequestBody Computer computer) {
